...
public class Graph {
     ...
     */
    Map<Integer, NodeList> map = new HashMap<Integer, NodeList>();
    ...
    public void addNode(Node n){
        ...
        map.put(n.nodeValue, nodeList);
        visited.put(n.nodeValue, false);
    }

    /*
     * This method adds the weighted edge between 2 nodes in the directed graph
     */
    public void add_Edge(int v1, int v2, int weight) {
        NodeList nodeListOne = map.get(v1);
        Node headOne = nodeListOne.head;
    ...
    public void createMinHeap(int size, int start) {
        queue = new PriorityQueue<Node>(size, (o1, o2) -> (o1.distance - o2.distance));
    ...
    public void calculateShortestPath() {
        ...
        while(!queue.isEmpty()) {
            ...
            NodeList nodeList = map.get(start.nodeValue);
            Node listNode = nodeList.head.next;
    ...
    public void printGraph() {
        for (NodeList nodeList : map.values()) {
            Node itrOne = nodeList.head;
            ...
            Node itrTwo = nodeList.head.next;
            while(itrTwo != null) {
